...
public abstract class Tetromino {
	...
	/**
	 * Añade este tetromino a una grilla. Si no se puede añadir por existir una colision, se termina el juego-
	 * @param grid La grilla en la cual se intentara añadir el bloque.
	 */
	...
	protected synchronized void reposition(int[][] newBlockCoords) {
		...
		for (int i = 0; i < tetrBlocks.length; i++) {														// Añade bloques
